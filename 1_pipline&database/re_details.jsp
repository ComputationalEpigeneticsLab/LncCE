...
//System.out.println(broad_cancer);
%>
<%
//basic
db.open();
...
<div class="content card card-body" style="height: 3478px;">
<iframe id="cancer_details" name="cancer_details" src="cancer_details.jsp?value1=0.5&tissue=<%=tissue_pd%>&mRNA_tissue=&Name=<%=ID %>&classification=<%=rs_a %>&resource=<%=resource %>&celltype=<%=cell%>&chr=<%=chr %>&NODE=<%=NODE %>&broad=<%=broad_cancer %>" style="width: 100%; height: 100%; margin: 0 auto; position: relative;" frameborder="0" scrolling="hidden"></iframe>		
</div>
</section>
...
<div class="content card card-content" style="height: 1877px;">
<iframe id="tissue_details" name="tissue_details" src="tissue_details.jsp?value1=0.5&tissue=<%=tissue_pd%>&mRNA_tissue=&Name=<%=ID %>&classification=<%=rs_a %>&resource=<%=resource %>&celltype=<%=cell%>&chr=<%=chr %>&NODE=<%=NODE %>" style="width: 100%; height: 100%; margin: 0 auto; position: relative;" frameborder="0" scrolling="hidden"></iframe>		
</div>
</section>
<%}else{ %>
<section id="floatMenu3">				
...
<iframe id="diffExp" name="diffExp" src="DiffExp.jsp?value1=0.5&tissue=<%=tissue_pd%>&mRNA_tissue=&Name=<%=ID %>&classification=<%=rs_a %>&resource=<%=resource %>&celltype=<%=cell%>&chr=<%=chr%>&NODE=<%=NODE %>" style="width: 100%; height: 100%; margin: 0 auto; position: relative;" frameborder="0" scrolling="hidden"></iframe>
</div>
