...
<div class="col">
	<a href = "#floatMenu2"><button type="button" class="btn button-color font-weight-bold">Spatial pattern in normal tissues</button></a>
</div>
<div class="col">
<%if(allsour.size()>0) {%>
<a href = "#floatMenu3"><button type="button" class="btn button-color font-weight-bold">Spatial pattern in cancers</button></a>
<%} %>
</div>
</div>
...
<div class="sidebar">
	<section id="floatMenu1">				
			...
			<div class="container">
				...
				<div class="col detail-col2"><span class="bastable-font"><%=tissue_pd %></span></div>
				</div>
...
<div class="heading">
<h3><a class="font-color">Spatial pattern in normal tissues</a></h3>
</div>
<div class="content card card-body" style="height: 3519px;">
<iframe id="tissue_details" name="tissue_details" src="tmp_tissue.jsp?value1=0.5&tissue=<%=tissue_pd%>&mRNA_tissue=&Name=<%=ID %>&classification=<%=rs_a %>&resource=<%=resource %>&celltype=<%=cell%>&chr=<%=chr %>&NODE=<%=NODE %>" style="width: 100%; height: 100%; margin: 0 auto; position: relative;" frameborder="0" scrolling="hidden"></iframe>		
</div>
</section>
<%
...
<div class="content card card-body" style="height: 1838px;">
<iframe id="cancer_details" name="cancer_details" src="tmp_cancer.jsp?value1=0.5&tissue=<%=tissue_pd%>&mRNA_tissue=&Name=<%=ID %>&classification=<%=rs_a %>&resource=<%=resource %>&celltype=<%=cell%>&chr=<%=chr%>&NODE=<%=NODE %>" style="width: 100%; height: 100%; margin: 0 auto; position: relative;" frameborder="0" scrolling="hidden"></iframe>		
</div>
</section>	
<%}else{ %>
<section id="floatMenu3">				
...
<div style="height:2401px;">
<iframe id="lnc_mrna" name="lnc_mrna" src="tmp_lncmrna.jsp?value1=0.5&tissue=<%=tissue_pd%>&mRNA_tissue=&Name=<%=ID %>&classification=<%=rs_a %>&resource=<%=resource %>&celltype=<%=cell%>&chr=<%=chr%>&NODE=<%=NODE %>" style="width: 100%; height: 100%; margin: 0 auto; position: relative;" frameborder="0" scrolling="hidden"></iframe>		
</div>
</section>
